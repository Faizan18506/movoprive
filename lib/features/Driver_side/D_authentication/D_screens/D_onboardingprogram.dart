...
// import 'package:movoprive/features/Driver_side/D_authentication/D_screens/Documents_uploadscreen.dart';
//
// class D_OnnboardingProgram extends StatefulWidget {
//   const D_OnnboardingProgram({Key? key}) : super(key: key);
//
//   @override
//   State<D_OnnboardingProgram> createState() =>
//       _PartnerOnboardingScreenState();
// }
//
// class _PartnerOnboardingScreenState extends State<D_OnnboardingProgram> {
...
//                       8,
//                           (index) => _buildProgressDot(index, 3),
//                     ),
//                   ),
...
//
//                       // Bulleted list
//                       _buildBulletPoint('Quality base bonus opportunities and the chance to join our partner \nPrestige Club'),
//                       _buildBulletPoint('Regular, reliable payment for ride'),
//                       _buildBulletPoint('Access to an established global customer base of business-class  \nTravelers'),
//                       _buildBulletPoint('Easy account management with our user-friendly chauffeur  app  \nand Online partner portal'),
//                       _buildBulletPoint('Choice of which rides you want to take to fill any gaps in your daily  \nSchedule'),
//                       const SizedBox(height: 12),
//                       Text(
//                         'Before you can perform your first ride and loin Movo Privé global network of partners we need your help with following',
//                         style: TextStyle(
//                           fontSize: 12,
//                         ),
//                       ),
//                       const SizedBox(height: 12),
//                       _buildBulletPoint('Upload 14 required document'),
//                       _buildBulletPoint('Complete 8 partner training modules'),
//                       _buildBulletPoint('Sign the partner agreement contact'),
//                       _buildBulletPoint('Submit your payment details'),
//                       _buildBulletPoint('Complete a live webinar'),
//                       const SizedBox(height: 12),
//                       Text(
//                         'Our team is looking forward to reviving your information and supporting you through the  registration process.',
//                         style: TextStyle(
//                           fontSize: 12,
//                         ),
//                       ),
...
//                               context,
//                               MaterialPageRoute(builder: (context) => D_DocumentUploadScreen()),
//                             );
//                           },
//                           child: Container(
//                             width: 95,
